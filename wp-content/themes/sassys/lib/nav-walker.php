...
if ( ! class_exists( 'sassys_WP_Bootstrap_Navwalker' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class sassys_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( '' !== $linkmod_type ) {
				...
				// Create image icon for design inspiration category link items
				if( in_array( 'menu-item-object-design-inspiration-cat', $classes, true ) ) {
  				...
  				$term_id = get_term_meta( $term -> term_id, 'category-image-id', true );
					$image 	 = wp_get_attachment_image( $term_id, array( 70, 70 ) );

					$item_output .= '<a' . $attributes . '>' . $image . '<span>';
				}
				
				else if( in_array( 'default-cat-image', $classes, true ) ) {
					$item_output .= '<a' . $attributes . '><img src="' . get_stylesheet_directory_uri() .
					'/images/default-cat-image.png" width="70" height="70" alt="" /><span>';
				}
			...
			if ( '' !== $linkmod_type ) {
				...
				// Close design inspiration category link items
				if( in_array( 'menu-item-object-design-inspiration-cat', $classes, true ) ) {
					$item_output .= '</span></a>';
				}
